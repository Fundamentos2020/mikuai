...
function LoadProductsDesc() {
    const xhr = new XMLHttpRequest();

    // Abrimos la conexion
    xhr.open('GET', api + "producto/descuento/" + pagAct, false);
        ...
        if(this.status === 200) {
            ...
            prd.data.productos.forEach(function loop(prod) {
                    ...
                    <div style="padding: 1em;" class="w-s-100 w-m-33">
                        ...
                        <div class="bxprdct">
                            <div class = "product" > <a onclick="loadProductoDes(event,${prod.id})" href=""> 
                            
                                <div class="des"> ${prod.descuento}% Off </div>     
                                <img src="https://picsum.photos/id/1/400/300" alt=""> </a> 
                            ...
                            <div class="row">
                                <div class="col-m-5 col-s-5 btnbox" >
                                    <a onclick="cpmrProdctsDes(event,${prod.id})" class="btn btncomprar" href="">Comprar</a>
                                </div>
...
function cargPagDes(){
    ...
    if(cantPag >= 1)
    {
        htmlPg += `<a onclick="ChangePageDes(event)"; class="pgna" href="">${"Anterior"}</a>
                    `;
    }
    ...
    for(let i=0; i <= cantPag ; i++)
    {
        if((i+1).toString() === pagAct.toString())
            htmlPg += `<a onclick="ChangePageDes(event)"; class="asel" href="">${i+1}</a>
                      `;
        else
            htmlPg += `<a onclick="ChangePageDes(event)"; class="pgna" href="">${i+1}</a>
                      `;
    }
    if(cantPag >= 1)
    {
        htmlPg += `<a onclick="ChangePageDes(event)"; class="pgna" href="">${"Siguiente"}</a>
                    `;
    }
            ...
            <div class="about w-s-50 w-m-50">
                ...
                <div style="margin-bottom: 2em;" class="contn contn-s">
                    <div class="w-s-45 w-m-45 m-r">
                        <div class="desc"> ${prd.data.producto[0].descuento}% Off </div>
                        <img class="foto" style="width: 100%; display: block;" src="https://picsum.photos/500/300" alt="">
                    </div>
    
                    <!-- Info -->
                    <div class="infp w-m-txt w-s-txt">
    
                        <div style="font-weight: bold; font-size: 2em; margin-top: 2em; margin-bottom: 1em;"> <strike>$${prd.data.producto[0].precio}</strike> 
                        - ${prd.data.producto[0].precio - (prd.data.producto[0].precio*(prd.data.producto[0].descuento/100))}</div>
                        ...
                        <div style="margin-top: 3em;" class="row">
                            <div class="col-m-5 col-s-5 btnbox" >
                                <a onclick="cpmrProdDes(event,${prd.data.producto[0].id})" onclick="compras(evemt,'solo')" class="btn btncomprar" href="">Comprar</a>
                            </div>
                            <div class="col-m-7 col-s-7 btnbox" >
...
function atras(e) {
    ...
    document.getElementById('titleh').innerText = "MiKuai | Descuentos y Rebajas";
    LoadProductsDesc();
}

function atrasCDes(e,t) {
    e.preventDefault();
    document.getElementById('btnatrs').innerHTML = ``;
    document.getElementById('contnprd').innerHTML = ``;
...
function cpmrProdDes(e,t){
    ...
    <div class="row pdconten pdconten-m" >
        ...
        <div style="width: 100%;" class="row">
            ...
            <div style="padding-left: 0.5em;  margin-top: 1em;" class="col-m-2 col-s-12">
                <button onclick="atrasCDes(event,${t})" class="btn btnatras">Cancelar</button>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-m-7 row">
                        ...
                        <div style="margin-bottom: 1em;" class="contn contn-s">
                            <img class="foto w-s-45 w-m-45 m-r" src="https://picsum.photos/500/300" alt="">
...
function cpmrProdctsDes(e,t){
    ...
    <div class="row pdconten pdconten-m" >
        ...
        <div style="width: 100%;" class="row">
            ...
            <div style="padding-left: 0.5em;  margin-top: 1em;" class="col-m-2 col-s-12">
                <button onclick="atrasCPrdctsDes(event,${t})" class="btn btnatras">Cancelar</button>
            </div>
